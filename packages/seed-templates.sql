...
> @treksistem/db-schema@0.1.0 db:seed /Users/abdullah/tmp/treksistem-latest/packages/db-schema
> tsx scripts/seed.ts

🌱 Master Service Templates Seeding Script

🔍 Validating master service templates...
✅ Template "Standard Motorcycle Taxi (Ojek)" is valid
✅ Template "Food Delivery Courier" is valid
✅ Template "Package Courier Service" is valid
✅ Template "Basic Car Shuttle Service" is valid
✅ Template "Non-Emergency Ambulance Transport" is valid
✅ All templates are valid!

📝 Generating SQL INSERT statements...
📄 Generated SQL for seeding master service templates:
================================================================================
...
1. Copy the SQL above to a file (e.g., seed-templates.sql)
2. Run: wrangler d1 execute TREKSISTEM_DB --local --file=seed-templates.sql
3. For production: wrangler d1 execute TREKSISTEM_DB --file=seed-templates.sql
